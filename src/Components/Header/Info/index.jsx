    ...
    return(
        <div className={"info-header-container " + (ligth && "info-header-container-li")}>
            <ul>
                ...
                <li>Then you can check the data entered and if you consider it correct, press on <div className="results-button-container"><button>Results</button></div> or "Shift + Enter" and that's it! </li>
